...
<head>
    ...
    <!-- //font-awesome-icons -->
    <!-- /Fonts -->
    <link href="{{url('//fonts.googleapis.com/css?family=Lato:100,100i,300,300i,400,400i,700')}}" rel="stylesheet">
    <link href="{{url('//fonts.googleapis.com/css?family=Source+Sans+Pro:200,200i,300,300i,400,400i,600,600i,700,700i,900')}}" rel="stylesheet">
    <!-- //Fonts -->
    ...
    <div class="main-banner inner" id="home">
        ...
        <header class="header">
            <div class="container-fluid px-lg-5">
                ...
                <nav class="py-4">
                    <div id="logo">
                        <h1> <a href="{{url('index')}}"><span class="fa fa-bold" aria-hidden="true"></span>ootie</a></h1>
                    </div>
